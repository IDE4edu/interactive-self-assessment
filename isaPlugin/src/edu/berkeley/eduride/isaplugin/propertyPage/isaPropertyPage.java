package edu.berkeley.eduride.isaplugin.propertyPage;
...
public class isaPropertyPage extends PropertyPage {
	...
	/**
	 * Constructor for isaPropertyPage.
	 */
	public isaPropertyPage() {
		super();
	}
