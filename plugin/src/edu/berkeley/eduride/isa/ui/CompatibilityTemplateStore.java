...
public final class CompatibilityTemplateStore extends ContributionTemplateStore {
	...
	private edu.berkeley.eduride.isa.corext.template.java.TemplateSet fLegacySet;

	public CompatibilityTemplateStore(ContextTypeRegistry registry, IPreferenceStore store, String key, edu.berkeley.eduride.isa.corext.template.java.TemplateSet legacySet) {
	...
	private boolean isCodeTemplates() {
		return fLegacySet instanceof edu.berkeley.eduride.isa.corext.template.java.CodeTemplates;
	}
