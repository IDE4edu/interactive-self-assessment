...
import edu.berkeley.eduride.isa.corext.refactoring.reorg.IConfirmQuery;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.IReorgQueries;
...
public class ReorgQueries implements IReorgQueries {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.reorg2.IReorgQueries#createYesYesToAllNoNoToAllQuery(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.reorg2.IReorgQueries#createYesNoQuery(java.lang.String)
	 */
	...
	private static class YesYesToAllNoNoToAllQuery implements IConfirmQuery{
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.refactoring.reorg2.IConfirmQuery#confirm(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.refactoring.reorg2.IConfirmQuery#confirm(java.lang.String, java.lang.Object[])
		 */
	...
	private static class YesNoQuery implements IConfirmQuery{
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.refactoring.reorg2.IReorgQueries.IConfirmQuery#confirm(java.lang.String, java.lang.Object[])
		 */
		public boolean confirm(String question, Object[] elements) throws OperationCanceledException {
			final int[] result= new int[1];
			fShell.getDisplay().syncExec(createQueryRunnable(question, elements, result));
