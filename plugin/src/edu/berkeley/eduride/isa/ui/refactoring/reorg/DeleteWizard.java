...
import edu.berkeley.eduride.isa.ui.refactoring.MessageWizardPage;
...
public class DeleteWizard extends RefactoringWizard {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.refactoring.RefactoringWizard#getMessageLineWidthInChars()
	 */
