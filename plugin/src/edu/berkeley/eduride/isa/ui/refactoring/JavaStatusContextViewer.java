...
import edu.berkeley.eduride.isa.ui.javaeditor.InternalClassFileEditorInput;
...
public class JavaStatusContextViewer extends TextStatusContextViewer {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.refactoring.IStatusContextViewer#createControl(org.eclipse.swt.widgets.Composite)
	 */
