...
import edu.berkeley.eduride.isa.ui.util.RowLayouter;
...
public class ExtractTempWizard extends RefactoringWizard {
	...
	private static class ExtractTempInputPage extends TextInputWizardPage {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.refactoring.TextInputWizardPage#textModified(java.lang.String)
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.refactoring.TextInputWizardPage#validateTextField(String)
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.refactoring.TextInputWizardPage#isInitialInputValid()
		 */
