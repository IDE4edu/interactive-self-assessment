...
import edu.berkeley.eduride.isa.ui.viewsupport.TreeHierarchyLayoutProblemsDecorator;
...
class PackagesViewLabelProvider extends AppearanceAwareLabelProvider {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaUILabelProvider#getRichTextLabel(java.lang.Object)
	 */
