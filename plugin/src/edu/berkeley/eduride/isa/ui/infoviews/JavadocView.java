 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui.infoviews;
...
import edu.berkeley.eduride.isa.ui.actions.SimpleSelectionProvider;
import edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor;
import edu.berkeley.eduride.isa.ui.text.java.hover.JavadocHover;
import edu.berkeley.eduride.isa.ui.text.javadoc.JavadocContentAccess2;
import edu.berkeley.eduride.isa.ui.viewsupport.BasicElementLabels;
import edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks;
...
public class JavadocView extends AbstractInfoView {
	...
	private static final class JavaElementBrowserInput extends BrowserInput {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.ui.infoviews.JavadocView.IBrowserInput#getInputElement()
		 */
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.ui.infoviews.JavadocView.IBrowserInput#getInputName()
		 */
...
//				});
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#fillActionBars(org.eclipse.ui.IActionBars)
	 * @since 3.4
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#fillToolBar(org.eclipse.jface.action.IToolBarManager)
	 * @since 3.4
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#menuAboutToShow(org.eclipse.jface.action.IMenuManager)
	 * @since 3.4
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#getSelectAllAction()
	 * @since 3.0
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#getCopyToClipboardAction()
	 * @since 3.0
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#getBackgroundColorKey()
	 * @since 3.2
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#computeInput(org.eclipse.ui.IWorkbenchPart, org.eclipse.jface.viewers.ISelection, org.eclipse.jdt.core.IJavaElement, org.eclipse.core.runtime.IProgressMonitor)
	 * @since 3.4
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#isIgnoringNewInput(org.eclipse.jdt.core.IJavaElement, org.eclipse.jface.viewers.ISelection)
	 * @since 3.2
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.infoviews.AbstractInfoView#getHelpContextId()
	 * @since 3.1
	 */
	...
	/**
	 * see also edu.berkeley.eduride.isa.ui.text.java.hover.JavadocHover.addLinkListener(BrowserInformationControl)
	 *
	...
	private void addLinkListener(Browser browser) {
		browser.addLocationListener(JavaElementLinks.createLocationListener(new JavaElementLinks.ILinkHandler() {
			...
			/* (non-Javadoc)
			 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks.ILinkHandler#handleDeclarationLink(org.eclipse.jdt.core.IJavaElement)
			 */
			...
			/* (non-Javadoc)
			 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks.ILinkHandler#handleExternalLink(java.net.URL, org.eclipse.swt.widgets.Display)
			 */
			...
			/* (non-Javadoc)
			 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks.ILinkHandler#handleInlineJavadocLink(org.eclipse.jdt.core.IJavaElement)
			 */
			...
			/* (non-Javadoc)
			 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks.ILinkHandler#handleJavadocViewLink(org.eclipse.jdt.core.IJavaElement)
			 */
			...
			/* (non-Javadoc)
			 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaElementLinks.ILinkHandler#handleTextSet()
			 */
