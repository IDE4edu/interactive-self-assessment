...
public class ContributedCleanUpTabPage extends CleanUpTabPage {
	...
	public void setWorkingValues(Map workingValues) {
		...
		final CleanUpOptions options= new CleanUpOptions(workingValues) {
			/*
			 * @see edu.berkeley.eduride.isa.ui.fix.CleanUpOptions#setOption(java.lang.String, java.lang.String)
			 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.preferences.formatter.ModifyDialogTabPage#doCreatePreferences(org.eclipse.swt.widgets.Composite, int)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.preferences.cleanup.CleanUpTabPage#getSelectedCleanUpCount()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.preferences.cleanup.CleanUpTabPage#getCleanUpCount()
	 */
