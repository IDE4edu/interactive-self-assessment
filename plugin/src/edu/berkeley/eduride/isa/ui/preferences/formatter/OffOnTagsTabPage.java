...
public class OffOnTagsTabPage extends FormatterTabPage {
	...
	protected void doCreatePreferences(Composite composite, int numColumns) {
		...
		IInputValidator inputValidator= new IInputValidator() {
			/*
			 * @see edu.berkeley.eduride.isa.ui.preferences.formatter.ModifyDialogTabPage.StringPreference.Validator#isValid(java.lang.String)
			 * @since 3.6
			 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.preferences.formatter.ModifyDialogTabPage#initializePage()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.preferences.formatter.ModifyDialogTabPage#doCreateJavaPreview(org.eclipse.swt.widgets.Composite)
	 */
