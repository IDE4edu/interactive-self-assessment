...
public class JavaTemplatePreferencePage extends TemplatePreferencePage {
	...
	protected Template editTemplate(Template template, boolean edit, boolean isNameModifiable) {
		edu.berkeley.eduride.isa.ui.preferences.EditTemplateDialog dialog= new edu.berkeley.eduride.isa.ui.preferences.EditTemplateDialog(getShell(), template, edit, isNameModifiable, getContextTypeRegistry());
