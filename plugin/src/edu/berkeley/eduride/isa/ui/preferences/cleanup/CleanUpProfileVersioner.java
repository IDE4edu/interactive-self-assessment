...
public class CleanUpProfileVersioner implements IProfileVersioner {
	...
	/* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.preferences.cleanup.IProfileVersioner#getFirstVersion()
     */
	...
	/* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.preferences.cleanup.IProfileVersioner#getCurrentVersion()
     */
	...
	/* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.preferences.cleanup.IProfileVersioner#updateAndComplete(edu.berkeley.eduride.isa.ui.preferences.cleanup.ProfileManager.CustomProfile)
     */
