...
import edu.berkeley.eduride.isa.ui.text.AbstractInformationControl;
import edu.berkeley.eduride.isa.ui.typehierarchy.SuperTypeHierarchyViewer.SuperTypeHierarchyContentProvider;
import edu.berkeley.eduride.isa.ui.typehierarchy.TraditionalHierarchyViewer.TraditionalHierarchyContentProvider;
...
public class HierarchyInformationControl extends AbstractInformationControl {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.JavaOutlineInformationControl#createTreeViewer(org.eclipse.swt.widgets.Composite, int)
	 */
	...
	protected String getId() {
		return "edu.berkeley.eduride.isa.ui.typehierarchy.QuickHierarchy"; //$NON-NLS-1$
	}
