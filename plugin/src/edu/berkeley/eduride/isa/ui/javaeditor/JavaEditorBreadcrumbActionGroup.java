...
import edu.berkeley.eduride.isa.ui.wizards.buildpaths.newsourcepage.GenerateBuildPathActionGroup;
import edu.berkeley.eduride.isa.ui.workingsets.ConfigureWorkingSetAssignementAction;
...
final class JavaEditorBreadcrumbActionGroup extends CompositeActionGroup	 {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.actions.CompositeActionGroup#fillContextMenu(org.eclipse.jface.action.IMenuManager)
	 */
	public void fillContextMenu(IMenuManager menu) {
