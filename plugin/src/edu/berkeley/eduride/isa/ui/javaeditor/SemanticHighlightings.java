...
public class SemanticHighlightings {
	...
	private static final class StaticFinalFieldHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#getPreferenceKey()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.ISemanticHighlighting#getDefaultTextColor()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.ISemanticHighlighting#getDefaultTextStyleBold()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#isItalicByDefault()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#isEnabledByDefault()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.ISemanticHighlighting#getDisplayName()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#consumes(edu.berkeley.eduride.isa.ui.javaeditor.SemanticToken)
		 */
	...
	private static final class AutoboxHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#consumesLiteral(edu.berkeley.eduride.isa.ui.javaeditor.SemanticToken)
		 */
	...
	private static final class MethodDeclarationHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.ISemanticHighlighting#isMatched(org.eclipse.jdt.core.dom.ASTNode)
		 */
		public boolean consumes(SemanticToken token) {
	...
	static final class DeprecatedMemberHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.SemanticHighlighting#isStrikethroughByDefault()
		 * @since 3.1
		 */
