...
import edu.berkeley.eduride.isa.corext.fix.CleanUpPreferenceUtil;
import edu.berkeley.eduride.isa.corext.util.JavaModelUtil;
import edu.berkeley.eduride.isa.ui.IJavaHelpContextIds;
import edu.berkeley.eduride.isa.ui.IJavaStatusConstants;
import edu.berkeley.eduride.isa.ui.JavaPlugin;
import edu.berkeley.eduride.isa.ui.actions.AddBlockCommentAction;
import edu.berkeley.eduride.isa.ui.actions.CompositeActionGroup;
import edu.berkeley.eduride.isa.ui.actions.IndentAction;
import edu.berkeley.eduride.isa.ui.actions.RemoveBlockCommentAction;
import edu.berkeley.eduride.isa.ui.actions.SurroundWithActionGroup;
import edu.berkeley.eduride.isa.ui.compare.LocalHistoryActionGroup;
import edu.berkeley.eduride.isa.ui.preferences.SaveParticipantPreferencePage;
import edu.berkeley.eduride.isa.ui.text.ContentAssistPreference;
import edu.berkeley.eduride.isa.ui.text.JavaHeuristicScanner;
import edu.berkeley.eduride.isa.ui.text.SmartBackspaceManager;
import edu.berkeley.eduride.isa.ui.text.Symbols;
import edu.berkeley.eduride.isa.ui.text.correction.CorrectionCommandInstaller;
import edu.berkeley.eduride.isa.ui.text.java.IJavaReconcilingListener;
import edu.berkeley.eduride.isa.ui.text.java.JavaFormattingContext;
...
public class CompilationUnitEditor extends JavaEditor implements IJavaReconcilingListener {
	...
	private class ExitPolicy implements IExitPolicy {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.link.LinkedPositionUI.ExitPolicy#doExit(edu.berkeley.eduride.isa.ui.text.link.LinkedPositionManager, org.eclipse.swt.events.VerifyEvent, int, int)
		 */
...
//			removeActionActivationCode(ITextEditorActionConstants.SHIFT_RIGHT);
	...
	public void doSave(IProgressMonitor progressMonitor) {
		...
		System.err.println("You saved an ISA file...");
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor#installOverrideIndicator(boolean)
	 * @since 3.0
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor#uninstallOverrideIndicator()
	 * @since 3.0
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor#createJavaSourceViewer(org.eclipse.swt.widgets.Composite, org.eclipse.jface.text.source.IVerticalRuler, org.eclipse.jface.text.source.IOverviewRuler, boolean, int)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.IJavaReconcilingListener#aboutToBeReconciled()
	 * @since 3.0
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor#getAdapter(java.lang.Class)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor#createNavigationActions()
	 */
