...
public class AddImportOnSelectionAction extends Action implements IUpdate {
	...
	private static class SelectTypeQuery implements IChooseImportQuery {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.codemanipulation.AddImportsOperation.IChooseImportQuery#chooseImport(edu.berkeley.eduride.isa.corext.util.TypeInfo[], java.lang.String)
		 */
