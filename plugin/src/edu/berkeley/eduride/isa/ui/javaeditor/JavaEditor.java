...
import edu.berkeley.eduride.isa.ui.actions.CompositeActionGroup;
import edu.berkeley.eduride.isa.ui.actions.CopyQualifiedNameAction;
import edu.berkeley.eduride.isa.ui.actions.FoldingActionGroup;
import edu.berkeley.eduride.isa.ui.actions.SelectionConverter;
import edu.berkeley.eduride.isa.ui.javaeditor.breadcrumb.EditorBreadcrumb;
import edu.berkeley.eduride.isa.ui.javaeditor.breadcrumb.IBreadcrumb;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.GoToNextPreviousMemberAction;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.SelectionHistory;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.StructureSelectEnclosingAction;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.StructureSelectHistoryAction;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.StructureSelectNextAction;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.StructureSelectPreviousAction;
import edu.berkeley.eduride.isa.ui.javaeditor.selectionactions.StructureSelectionAction;
import edu.berkeley.eduride.isa.ui.search.BreakContinueTargetFinder;
import edu.berkeley.eduride.isa.ui.search.ExceptionOccurrencesFinder;
import edu.berkeley.eduride.isa.ui.search.IOccurrencesFinder;
import edu.berkeley.eduride.isa.ui.search.ImplementOccurrencesFinder;
import edu.berkeley.eduride.isa.ui.search.MethodExitsFinder;
import edu.berkeley.eduride.isa.ui.search.OccurrencesFinder;
import edu.berkeley.eduride.isa.ui.search.IOccurrencesFinder.OccurrenceLocation;
import edu.berkeley.eduride.isa.ui.text.DocumentCharacterIterator;
import edu.berkeley.eduride.isa.ui.text.JavaChangeHover;
import edu.berkeley.eduride.isa.ui.text.JavaPairMatcher;
import edu.berkeley.eduride.isa.ui.text.JavaWordFinder;
import edu.berkeley.eduride.isa.ui.text.JavaWordIterator;
import edu.berkeley.eduride.isa.ui.text.PreferencesAdapter;
import edu.berkeley.eduride.isa.ui.text.java.hover.JavaExpandHover;
import edu.berkeley.eduride.isa.ui.text.java.hover.SourceViewerInformationControl;
import edu.berkeley.eduride.isa.ui.util.JavaUIHelp;
import edu.berkeley.eduride.isa.ui.viewsupport.ISelectionListenerWithAST;
import edu.berkeley.eduride.isa.ui.viewsupport.IViewPartInputProvider;
import edu.berkeley.eduride.isa.ui.viewsupport.SelectionListenerWithASTManager;
...
public abstract class JavaEditor extends AbstractDecoratedTextEditor implements IViewPartInputProvider {
	...
	protected class NavigateNextSubWordAction extends NextSubWordAction {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor.NextSubWordAction#setCaretPosition(int)
		 */
	...
	protected class NavigatePreviousSubWordAction extends PreviousSubWordAction {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.javaeditor.JavaEditor.PreviousSubWordAction#setCaretPosition(int)
		 */
		protected void setCaretPosition(final int position) {
			getTextWidget().setCaretOffset(modelOffset2WidgetOffset(getSourceViewer(), position));
		}
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.viewsupport.IViewPartInputProvider#getViewPartInput()
	 */
