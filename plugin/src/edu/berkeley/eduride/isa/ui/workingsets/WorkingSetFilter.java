...
import edu.berkeley.eduride.isa.ui.packageview.ClassPathContainer.RequiredProjectWrapper;
import edu.berkeley.eduride.isa.ui.viewsupport.JavaViewerFilter;
...
public class WorkingSetFilter extends JavaViewerFilter {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.filters.JavaViewerFilter#initFilter()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.filters.JavaViewerFilter#freeFilter()
	 */
