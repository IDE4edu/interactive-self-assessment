...
import edu.berkeley.eduride.isa.ui.util.PixelConverter;
...
public class TypeSelectionComponent extends Composite implements ITypeSelectionComponent {
	...
	private static final String DIALOG_SETTINGS= "edu.berkeley.eduride.isa.ui.dialogs.TypeSelectionComponent"; //$NON-NLS-1$
