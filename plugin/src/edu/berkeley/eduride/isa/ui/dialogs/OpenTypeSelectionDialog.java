...
public class OpenTypeSelectionDialog extends FilteredTypesSelectionDialog {
	...
	private static final String DIALOG_SETTINGS= "edu.berkeley.eduride.isa.ui.dialogs.OpenTypeSelectionDialog2"; //$NON-NLS-1$
	 ...
	 * (non-Javadoc)
	 *
	 * @see edu.berkeley.eduride.isa.ui.dialogs.FilteredTypesSelectionDialog#getDialogSettings()
	 */
