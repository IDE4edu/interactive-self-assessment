...
class SearchScopeWorkingSetAction extends SearchScopeAction {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.callhierarchy.SearchScopeActionGroup.SearchScopeAction#getSearchScopeType()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.callhierarchy.SearchScopeAction#getFullDescription()
	 */
