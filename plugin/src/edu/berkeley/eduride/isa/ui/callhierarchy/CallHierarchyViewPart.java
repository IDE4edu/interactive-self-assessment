...
import edu.berkeley.eduride.isa.corext.callhierarchy.CallHierarchy;
import edu.berkeley.eduride.isa.corext.callhierarchy.CallLocation;
import edu.berkeley.eduride.isa.corext.callhierarchy.MethodWrapper;
import edu.berkeley.eduride.isa.corext.callhierarchy.RealCallers;
...
public class CallHierarchyViewPart extends ViewPart implements ICallHierarchyViewPart, ISelectionChangedListener {
	...
	private class CallHierarchySelectionProvider extends SelectionProviderMediator {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.ui.typehierarchy.SelectionProviderMediator#getSelection()
		 */
