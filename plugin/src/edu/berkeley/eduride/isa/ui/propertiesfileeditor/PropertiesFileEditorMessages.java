...
final class PropertiesFileEditorMessages extends NLS {
	...
	private static final String BUNDLE_FOR_CONSTRUCTED_KEYS= "edu.berkeley.eduride.isa.ui.propertiesfileeditor.ConstructedPropertiesFileEditorMessages";//$NON-NLS-1$
