 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui;
...
import edu.berkeley.eduride.isa.corext.fix.CleanUpRegistry;
import edu.berkeley.eduride.isa.corext.javadoc.JavaDocLocations;
import edu.berkeley.eduride.isa.corext.template.java.AbstractJavaContextType;
import edu.berkeley.eduride.isa.corext.template.java.CodeTemplateContextType;
import edu.berkeley.eduride.isa.corext.template.java.JavaContextType;
import edu.berkeley.eduride.isa.corext.template.java.SWTContextType;
import edu.berkeley.eduride.isa.corext.util.OpenTypeHistory;
...
import edu.berkeley.eduride.isa.ui.javaeditor.ASTProvider;
import edu.berkeley.eduride.isa.ui.javaeditor.ClassFileDocumentProvider;
import edu.berkeley.eduride.isa.ui.javaeditor.CompilationUnitDocumentProvider;
import edu.berkeley.eduride.isa.ui.javaeditor.DocumentAdapter;
import edu.berkeley.eduride.isa.ui.javaeditor.ICompilationUnitDocumentProvider;
import edu.berkeley.eduride.isa.ui.javaeditor.WorkingCopyManager;
...
import edu.berkeley.eduride.isa.ui.preferences.formatter.FormatterProfileStore;
import edu.berkeley.eduride.isa.ui.propertiesfileeditor.PropertiesFileDocumentProvider;
import edu.berkeley.eduride.isa.ui.text.PreferencesAdapter;
import edu.berkeley.eduride.isa.ui.text.folding.JavaFoldingStructureProviderRegistry;
import edu.berkeley.eduride.isa.ui.text.java.ContentAssistHistory;
import edu.berkeley.eduride.isa.ui.text.java.hover.JavaEditorTextHoverDescriptor;
...
import edu.berkeley.eduride.isa.ui.viewsupport.ImagesOnFileSystemRegistry;
import edu.berkeley.eduride.isa.ui.viewsupport.ProblemMarkerManager;
import edu.berkeley.eduride.isa.ui.wizards.buildpaths.ClasspathAttributeConfigurationDescriptors;
...
//			RefactoringCore.getConditionCheckingFailedSeverity());
	...
	public synchronized org.eclipse.jdt.core.IBufferFactory getBufferFactory() {
		if (fBufferFactory == null)
			fBufferFactory= new edu.berkeley.eduride.isa.ui.javaeditor.CustomBufferFactory();
	 ...
	 * @deprecated
	 */
	private edu.berkeley.eduride.isa.corext.template.java.Templates getOldTemplateStoreInstance() {
		return edu.berkeley.eduride.isa.corext.template.java.Templates.getInstance();
	}
	 ...
	 * @deprecated
	 */
	private edu.berkeley.eduride.isa.corext.template.java.CodeTemplates getOldCodeTemplateStoreInstance() {
		return edu.berkeley.eduride.isa.corext.template.java.CodeTemplates.getInstance();
	}
