...
public class JavaCompletionProcessor extends ContentAssistProcessor {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.ContentAssistProcessor#filterAndSort(java.util.List, org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.ContentAssistProcessor#createContext(org.eclipse.jface.text.ITextViewer, int)
	 */
