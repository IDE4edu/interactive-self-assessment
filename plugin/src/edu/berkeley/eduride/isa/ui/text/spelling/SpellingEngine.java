...
import edu.berkeley.eduride.isa.ui.text.spelling.engine.ISpellEvent;
import edu.berkeley.eduride.isa.ui.text.spelling.engine.ISpellEventListener;
...
public abstract class SpellingEngine implements ISpellingEngine {
	...
	protected static class SpellEventListener implements ISpellEventListener {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.spelling.engine.ISpellEventListener#handle(edu.berkeley.eduride.isa.ui.text.spelling.engine.ISpellEvent)
		 */
