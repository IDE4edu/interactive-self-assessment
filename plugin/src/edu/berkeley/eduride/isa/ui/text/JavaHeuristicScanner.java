...
public final class JavaHeuristicScanner implements Symbols {
	...
	private static class NonWhitespace extends StopCondition {
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
	...
	private final class NonWhitespaceDefaultPartition extends NonWhitespace {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaHeuristicScanner.StopCondition#nextPosition(int, boolean)
		 */
		public int nextPosition(int position, boolean forward) {
	...
	private final class CharacterMatch extends StopCondition {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaHeuristicScanner.StopCondition#stop(char, int)
		 */
		public boolean stop(char ch, int position, boolean forward) {
