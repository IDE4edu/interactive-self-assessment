...
public class JavaBreakIterator extends BreakIterator {
	...
	static final class LineDelimiter extends Run {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaBreakIterator.Run#init()
		 */
		protected void init() {
			super.init();
			fState= INIT;
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaBreakIterator.Run#consume(char)
		 */
		protected boolean consume(char ch) {
	...
	static final class Identifier extends Run {
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaBreakIterator.Run#isValid(char)
		 */
		protected boolean isValid(char ch) {
	...
	static final class CamelCaseIdentifier extends Run {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.JavaBreakIterator.Run#consumes(char)
		 */
		protected boolean consume(char ch) {
			int kind= getKind(ch);
