...
import edu.berkeley.eduride.isa.corext.fix.ILinkedFix;
import edu.berkeley.eduride.isa.corext.fix.IProposableFix;
import edu.berkeley.eduride.isa.corext.fix.CleanUpRefactoring.MultiFixTarget;
import edu.berkeley.eduride.isa.corext.util.Messages;
import edu.berkeley.eduride.isa.ui.JavaPlugin;
import edu.berkeley.eduride.isa.ui.fix.IMultiFix;
...
import edu.berkeley.eduride.isa.ui.text.correction.IStatusLineProposal;
...
public class FixCorrectionProposal extends CUCorrectionProposal implements ICompletionProposalExtension2, IStatusLineProposal {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.ChangeCorrectionProposal#getImage()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.CUCorrectionProposal#getAdditionalProposalInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.ChangeCorrectionProposal#getRelevance()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.CUCorrectionProposal#createTextChange()
	 */
