...
import edu.berkeley.eduride.isa.ui.javaeditor.NLSKeyHyperlink;
...
public class NLSStringHover extends AbstractJavaEditorTextHover {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.hover.AbstractJavaEditorTextHover#getHoverRegion(org.eclipse.jface.text.ITextViewer, int)
	 */
