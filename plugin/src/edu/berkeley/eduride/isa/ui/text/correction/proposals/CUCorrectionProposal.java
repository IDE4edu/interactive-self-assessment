...
public class CUCorrectionProposal extends ChangeCorrectionProposal  {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.ChangeCorrectionProposal#performChange(org.eclipse.jface.text.IDocument, org.eclipse.ui.IEditorPart)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.ChangeCorrectionProposal#createChange()
	 */
