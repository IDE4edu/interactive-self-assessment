...
import edu.berkeley.eduride.isa.ui.text.correction.ModifierCorrectionSubProcessor;
...
public class NewMethodCorrectionProposal extends AbstractMethodCorrectionProposal {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#addNewModifiers(org.eclipse.jdt.core.dom.rewrite.ASTRewrite, java.util.List)
	 */
	...
	/*(non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#isConstructor()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#getNewName(org.eclipse.jdt.core.dom.rewrite.ASTRewrite)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#getNewMethodType(org.eclipse.jdt.core.dom.rewrite.ASTRewrite)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#addNewParameters(org.eclipse.jdt.core.dom.rewrite.ASTRewrite, java.util.List, java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#addNewExceptions(org.eclipse.jdt.core.dom.rewrite.ASTRewrite, java.util.List)
	 */
	protected void addNewExceptions(ASTRewrite rewrite, List exceptions) throws CoreException {
	}

	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#addNewTypeParameters(org.eclipse.jdt.core.dom.rewrite.ASTRewrite, java.util.List, java.util.List)
	 */
