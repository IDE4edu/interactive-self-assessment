...
import edu.berkeley.eduride.isa.corext.dom.BodyDeclarationRewrite;
import edu.berkeley.eduride.isa.corext.dom.Selection;
import edu.berkeley.eduride.isa.corext.fix.CleanUpConstants;
import edu.berkeley.eduride.isa.corext.fix.CodeStyleFix;
import edu.berkeley.eduride.isa.corext.fix.IProposableFix;
import edu.berkeley.eduride.isa.corext.fix.Java50Fix;
import edu.berkeley.eduride.isa.corext.fix.StringFix;
import edu.berkeley.eduride.isa.corext.fix.UnimplementedCodeFix;
import edu.berkeley.eduride.isa.corext.fix.UnusedCodeFix;
import edu.berkeley.eduride.isa.corext.refactoring.surround.ExceptionAnalyzer;
import edu.berkeley.eduride.isa.corext.refactoring.surround.SurroundWithTryCatchRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.util.NoCommentSourceRangeComputer;
import edu.berkeley.eduride.isa.corext.refactoring.util.TightSourceRangeComputer;
...
import edu.berkeley.eduride.isa.ui.fix.CodeStyleCleanUp;
import edu.berkeley.eduride.isa.ui.fix.Java50CleanUp;
import edu.berkeley.eduride.isa.ui.fix.StringCleanUp;
import edu.berkeley.eduride.isa.ui.fix.UnimplementedCodeCleanUp;
import edu.berkeley.eduride.isa.ui.fix.UnnecessaryCodeCleanUp;
...
import edu.berkeley.eduride.isa.ui.refactoring.nls.ExternalizeWizard;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ASTRewriteCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.CUCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ChangeCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ChangeMethodSignatureProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ConstructorFromSuperclassProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.FixCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.LinkedCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.LinkedNamesAssistProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.MissingAnnotationAttributesProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.NewVariableCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ReplaceCorrectionProposal;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ChangeMethodSignatureProposal.ChangeDescription;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ChangeMethodSignatureProposal.InsertDescription;
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ChangeMethodSignatureProposal.RemoveDescription;
