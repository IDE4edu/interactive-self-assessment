...
import edu.berkeley.eduride.isa.ui.text.CombinedWordRule.WordMatcher;
...
public class JavaCommentScanner extends AbstractJavaScanner{
	...
	private class TaskTagMatcher extends CombinedWordRule.WordMatcher {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.CombinedWordRule.WordMatcher#clearWords()
		 * @since 3.0
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.CombinedWordRule.WordMatcher#addWord(java.lang.String, org.eclipse.jface.text.rules.IToken)
		 * @since 3.0
		 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractJavaScanner#affectsBehavior(org.eclipse.jface.util.PropertyChangeEvent)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractJavaScanner#adaptToPreferenceChange(org.eclipse.jface.util.PropertyChangeEvent)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractJavaScanner#getTokenProperties()
	 */
