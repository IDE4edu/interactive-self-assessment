...
import edu.berkeley.eduride.isa.ui.javaeditor.JavaAnnotationIterator;
...
public abstract class AbstractAnnotationHover extends AbstractJavaEditorTextHover {
	...
	private static class AnnotationInformationControl extends AbstractInformationControl implements IInformationControlExtension2 {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.text.java.hover.AbstractAnnotationHover.AbstractInformationControl#setFocus()
		 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.hover.AbstractJavaEditorTextHover#getHoverInfo2(org.eclipse.jface.text.ITextViewer, org.eclipse.jface.text.IRegion)
	 * @since 3.4
	 */
