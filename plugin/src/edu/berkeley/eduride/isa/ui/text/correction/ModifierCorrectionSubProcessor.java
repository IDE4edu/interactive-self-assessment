...
import edu.berkeley.eduride.isa.corext.fix.LinkedProposalPositionGroup;
import edu.berkeley.eduride.isa.corext.fix.UnimplementedCodeFix;
import edu.berkeley.eduride.isa.corext.fix.CompilationUnitRewriteOperationsFix.CompilationUnitRewriteOperation;
import edu.berkeley.eduride.isa.corext.fix.UnimplementedCodeFix.MakeTypeAbstractOperation;
...
import edu.berkeley.eduride.isa.ui.text.correction.proposals.ModifierChangeCorrectionProposal;
...
public class ModifierCorrectionSubProcessor {
	...
	private static class ModifierLinkedModeProposal extends LinkedProposalPositionGroup.Proposal {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.fix.PositionGroup.Proposal#computeEdits(int, org.eclipse.jface.text.link.LinkedPosition, char, int, org.eclipse.jface.text.link.LinkedModeModel)
		 */
