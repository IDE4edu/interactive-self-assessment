...
public final class JavadocLinkTypeCompletionProposal extends LazyJavaTypeCompletionProposal {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaTypeCompletionProposal#computeReplacementString()
	 */
...
//			return "{@link " + typeReplacement; //$NON-NLS-1$
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaTypeCompletionProposal#apply(org.eclipse.jface.text.IDocument, char, int)
	 */
