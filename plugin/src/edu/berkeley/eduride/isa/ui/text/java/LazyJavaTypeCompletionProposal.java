...
public class LazyJavaTypeCompletionProposal extends LazyJavaCompletionProposal {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeReplacementString()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#apply(org.eclipse.jface.text.IDocument, char, int)
	 */
...
//				return false;
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#isValidPrefix(java.lang.String)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.JavaCompletionProposal#getCompletionText()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeTriggerCharacters()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeProposalInfo()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeSortString()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeRelevance()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.java.LazyJavaCompletionProposal#computeContextInformation()
	 * @since 3.3
	 */
