 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui.text.template.contentassist;
...
import edu.berkeley.eduride.isa.ui.text.correction.SurroundWith;
...
public class SurroundWithTemplateProposal extends TemplateProposal {
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.template.contentassist.TemplateProposal#getAdditionalProposalInfo()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.template.contentassist.TemplateProposal#apply(org.eclipse.jface.text.ITextViewer, char, int, int)
	 */
