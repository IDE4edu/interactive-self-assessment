...
public class NewDefiningMethodProposal extends AbstractMethodCorrectionProposal {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#getNewName()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.text.correction.AbstractMethodCompletionProposal#addNewExceptions(org.eclipse.jdt.core.dom.AST, java.util.List)
	 */
