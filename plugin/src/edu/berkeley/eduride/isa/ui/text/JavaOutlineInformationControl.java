...
import edu.berkeley.eduride.isa.ui.actions.CategoryFilterActionGroup;
import edu.berkeley.eduride.isa.ui.typehierarchy.AbstractHierarchyViewerSorter;
import edu.berkeley.eduride.isa.ui.util.StringMatcher;
import edu.berkeley.eduride.isa.ui.viewsupport.AppearanceAwareLabelProvider;
import edu.berkeley.eduride.isa.ui.viewsupport.ColoredViewersManager;
import edu.berkeley.eduride.isa.ui.viewsupport.ColoringLabelProvider;
...
public class JavaOutlineInformationControl extends AbstractInformationControl {
	...
	private class OutlineLabelProvider extends AppearanceAwareLabelProvider {
		...
		/*
		 * @see edu.berkeley.eduride.isa.ui.viewsupport.JavaUILabelProvider#getForeground(java.lang.Object)
		 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractInformationControl#getId()
	 * @since 3.0
	 */
	protected String getId() {
		return "edu.berkeley.eduride.isa.ui.text.QuickOutline"; //$NON-NLS-1$
	}
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractInformationControl#fillViewMenu(org.eclipse.jface.action.IMenuManager)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.ui.text.AbstractInformationControl#setMatcherString(java.lang.String, boolean)
	 * @since 3.2
	 */
