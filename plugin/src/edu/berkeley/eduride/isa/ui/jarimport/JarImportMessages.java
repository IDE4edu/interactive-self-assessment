 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui.jarimport;
...
public final class JarImportMessages extends NLS {
	...
	private static final String BUNDLE_NAME= "edu.berkeley.eduride.isa.ui.jarimport.JarImportMessages";//$NON-NLS-1$
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, JarImportMessages.class);
	}
