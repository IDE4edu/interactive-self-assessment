 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui.wizards.dialogfields;
...
public class SelectionButtonDialogField extends DialogField {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.wizards.dialogfields.DialogField#setLabelText(java.lang.String)
	 */
	...
	/*(non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.wizards.dialogfields.DialogField#refresh()
	 */
	public void refresh() {
		super.refresh();
		if (isOkToUse(fButton)) {
