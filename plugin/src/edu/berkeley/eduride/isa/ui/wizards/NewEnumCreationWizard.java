 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.ui.wizards;
...
public class NewEnumCreationWizard extends NewElementWizard {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.wizards.NewElementWizard#canRunForked()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.wizards.NewElementWizard#finishPage(org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.ui.wizards.NewElementWizard#getCreatedElement()
	 */
