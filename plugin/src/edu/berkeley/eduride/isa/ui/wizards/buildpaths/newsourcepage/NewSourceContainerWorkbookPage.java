...
import edu.berkeley.eduride.isa.corext.buildpath.IBuildpathModifierListener;
import edu.berkeley.eduride.isa.ui.JavaPlugin;
import edu.berkeley.eduride.isa.ui.preferences.ScrolledPageContent;
import edu.berkeley.eduride.isa.ui.util.ViewerPane;
import edu.berkeley.eduride.isa.ui.wizards.NewWizardMessages;
import edu.berkeley.eduride.isa.ui.wizards.buildpaths.BuildPathBasePage;
...
public class NewSourceContainerWorkbookPage extends BuildPathBasePage implements IBuildpathModifierListener {
    ...
    public static final String OPEN_SETTING= "edu.berkeley.eduride.isa.ui.wizards.buildpaths.NewSourceContainerPage.openSetting";  //$NON-NLS-1$
    ...
    /* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.wizards.buildpaths.BuildPathBasePage#getSelection()
     */
    ...
    /* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.wizards.buildpaths.BuildPathBasePage#setSelection(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see edu.berkeley.eduride.isa.ui.wizards.buildpaths.BuildPathBasePage#isEntryKind(int)
     */
