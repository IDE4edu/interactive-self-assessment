...
import edu.berkeley.eduride.isa.corext.util.TypeNameMatchCollector;
import edu.berkeley.eduride.isa.ui.JavaPlugin;
import edu.berkeley.eduride.isa.ui.text.correction.ASTResolving;
import edu.berkeley.eduride.isa.ui.text.correction.SimilarElementsRequestor;
import edu.berkeley.eduride.isa.ui.text.template.contentassist.MultiVariable;
import edu.berkeley.eduride.isa.ui.text.template.contentassist.MultiVariableGuess;
...
//				return resolver.createVariable();
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.template.DocumentTemplateContext#getEnd()
	 */
	public int getEnd() {
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.template.DocumentTemplateContext#getKey()
	 */
