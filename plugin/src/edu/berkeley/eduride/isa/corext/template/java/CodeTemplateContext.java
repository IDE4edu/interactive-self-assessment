...
public class CodeTemplateContext extends TemplateContext {
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.template.TemplateContext#evaluate(edu.berkeley.eduride.isa.corext.template.Template)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.template.TemplateContext#canEvaluate(edu.berkeley.eduride.isa.corext.template.Template)
	 */
