...
public class CodeTemplateContextType extends TemplateContextType {
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.template.ContextType#validateVariables(edu.berkeley.eduride.isa.corext.template.TemplateVariable[])
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.template.ContextType#createContext()
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.template.ContextType#validate(java.lang.String)
	 */
