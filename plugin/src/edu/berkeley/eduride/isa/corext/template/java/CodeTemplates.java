 ...
 * @since 3.0
 * @deprecated use {@link edu.berkeley.eduride.isa.ui.JavaPlugin#getCodeTemplateStore()} instead
 */
public class CodeTemplates extends edu.berkeley.eduride.isa.corext.template.java.TemplateSet {
