 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.corext.refactoring;
...
import edu.berkeley.eduride.isa.corext.fix.CleanUpRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.base.RefactoringStatusCodes;
import edu.berkeley.eduride.isa.corext.refactoring.code.ConvertAnonymousToNestedRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.code.InlineConstantRefactoring;
...
import edu.berkeley.eduride.isa.corext.refactoring.code.IntroduceIndirectionRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.code.IntroduceParameterRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.code.ReplaceInvocationsRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.generics.InferTypeArgumentsRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.JavaCopyProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.JavaDeleteProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.JavaMoveProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.ReorgPolicyFactory;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.IReorgPolicy.ICopyPolicy;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.IReorgPolicy.IMovePolicy;
...
import edu.berkeley.eduride.isa.corext.refactoring.structure.ChangeTypeRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.structure.ExtractClassRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.structure.ExtractInterfaceProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.ExtractSupertypeProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.IntroduceParameterObjectProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.MoveInnerToTopRefactoring;
import edu.berkeley.eduride.isa.corext.refactoring.structure.MoveInstanceMethodProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.MoveStaticMembersProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.PullUpRefactoringProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.PushDownRefactoringProcessor;
import edu.berkeley.eduride.isa.corext.refactoring.structure.UseSuperTypeProcessor;
import edu.berkeley.eduride.isa.corext.util.Messages;
import edu.berkeley.eduride.isa.ui.actions.ActionMessages;
import edu.berkeley.eduride.isa.ui.fix.CleanUpRefactoringWizard;
import edu.berkeley.eduride.isa.ui.preferences.JavaPreferencesSettings;
import edu.berkeley.eduride.isa.ui.refactoring.ChangeSignatureWizard;
import edu.berkeley.eduride.isa.ui.refactoring.ChangeTypeWizard;
import edu.berkeley.eduride.isa.ui.refactoring.ConvertAnonymousToNestedWizard;
import edu.berkeley.eduride.isa.ui.refactoring.ExtractClassWizard;
import edu.berkeley.eduride.isa.ui.refactoring.ExtractInterfaceWizard;
import edu.berkeley.eduride.isa.ui.refactoring.ExtractSupertypeWizard;
import edu.berkeley.eduride.isa.ui.refactoring.InferTypeArgumentsWizard;
import edu.berkeley.eduride.isa.ui.refactoring.InlineConstantWizard;
import edu.berkeley.eduride.isa.ui.refactoring.InlineTempWizard;
import edu.berkeley.eduride.isa.ui.refactoring.IntroduceFactoryWizard;
import edu.berkeley.eduride.isa.ui.refactoring.IntroduceIndirectionWizard;
import edu.berkeley.eduride.isa.ui.refactoring.IntroduceParameterObjectWizard;
import edu.berkeley.eduride.isa.ui.refactoring.IntroduceParameterWizard;
import edu.berkeley.eduride.isa.ui.refactoring.MoveInnerToTopWizard;
import edu.berkeley.eduride.isa.ui.refactoring.MoveInstanceMethodWizard;
import edu.berkeley.eduride.isa.ui.refactoring.MoveMembersWizard;
import edu.berkeley.eduride.isa.ui.refactoring.PullUpWizard;
import edu.berkeley.eduride.isa.ui.refactoring.PushDownWizard;
...
import edu.berkeley.eduride.isa.ui.refactoring.UseSupertypeWizard;
import edu.berkeley.eduride.isa.ui.refactoring.actions.RefactoringStarter;
import edu.berkeley.eduride.isa.ui.refactoring.code.InlineMethodWizard;
import edu.berkeley.eduride.isa.ui.refactoring.code.ReplaceInvocationsWizard;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.CreateTargetQueries;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.DeleteUserInterfaceManager;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.NewNameQueries;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.ReorgCopyWizard;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.ReorgMoveWizard;
import edu.berkeley.eduride.isa.ui.refactoring.reorg.ReorgQueries;
import edu.berkeley.eduride.isa.ui.refactoring.sef.SelfEncapsulateFieldWizard;
