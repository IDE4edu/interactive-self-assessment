...
public class TypeConstraintFactory implements ITypeConstraintFactory {
	 ...
	 * (non-Javadoc)
	 *
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ITypeConstraintFactory#createCompositeOrTypeConstraint(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ITypeConstraint[])
	 */
