...
import edu.berkeley.eduride.isa.corext.refactoring.reorg.SourceReferenceUtil;
...
public class PullUpRefactoringProcessor extends HierarchyProcessor {
	...
	private static final GroupCategorySet SET_PULL_UP= new GroupCategorySet(new GroupCategory("edu.berkeley.eduride.isa.corext.pullUp", //$NON-NLS-1$
