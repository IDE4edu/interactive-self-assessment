...
public class CompilationUnitRewrite {
	 ...
	 */
	public edu.berkeley.eduride.isa.corext.refactoring.changes.CompilationUnitChange createChange() throws CoreException {
		CompilationUnitChange change= createChange(true);
		if (change == null)
			return null;
		return new edu.berkeley.eduride.isa.corext.refactoring.changes.CompilationUnitChange(change);
	}
