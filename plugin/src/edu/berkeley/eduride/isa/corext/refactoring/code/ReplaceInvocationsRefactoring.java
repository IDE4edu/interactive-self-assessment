...
import edu.berkeley.eduride.isa.corext.refactoring.binary.StubCreator;
	...
	private SourceProvider resolveSourceProvider(IMethodBinding methodBinding, RefactoringStatus status) throws JavaModelException {
		...
		if (methodCu != null) {
			...
			StubCreator stubCreator= new StubCreator(true) {
				...
				/*
				 * @see edu.berkeley.eduride.isa.corext.refactoring.binary.StubCreator#appendMethodParameterName(org.eclipse.jdt.core.IMethod, int)
				 */
