...
package edu.berkeley.eduride.isa.corext.refactoring.generics;
...
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.GenericType;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ParameterizedType;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.TType;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.TypeVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.WildcardType;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ArrayElementVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.CollectionElementVariable2;
...
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.IndependentTypeVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ParameterTypeVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ParameterizedTypeVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ReturnTypeVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.TTypes;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.TypeVariable2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.VariableVariable2;
...
public class InferTypeArgumentsConstraintCreator extends HierarchicalASTVisitor {
	 ...
	 */
	private static final String CV_PROP= "edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.CONSTRAINT_VARIABLE"; //$NON-NLS-1$
...
//			fTCModel.createSubtypeConstraint(classTypeVariable, boundType);
		...
		for (int i= 0; i < arguments.size(); i++) {
			...
			if (! methodBinding.isVarargs() || i < lastParamIdx) {
				...
				if (i == lastParamIdx && canAssignToVararg(
						...
						(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType)) {
					//OK: argument will not be packed into an array
				} else {
					declaredParameterType= ((edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getComponentType();
				}
			}
			...
			if (declaredParameterType.isTypeVariable()) {
				...
				TType declaredElementType= ((edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getElementType();
	...
	private boolean canAssignToVararg(TType rhs, edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ArrayType lhs) {
