...
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.types.ArrayType;
...
public class SuperTypesSet extends TypeSet {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#isUniverse()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#makeClone()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#upperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#lowerBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#intersectedWith(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.EnumeratedTypeSet)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#superTypes()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#isEmpty()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#contains(TType)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#containsAll(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.EnumeratedTypeSet)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#isSingleton()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#anyMember()
	 */
...
//			return enumerate().equals(other.enumerate());
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#iterator()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#hasUniqueLowerBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#hasUniqueUpperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#uniqueLowerBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#uniqueUpperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#enumerate()
	 */
