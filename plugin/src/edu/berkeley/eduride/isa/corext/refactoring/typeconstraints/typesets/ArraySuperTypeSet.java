...
public class ArraySuperTypeSet extends ArrayTypeSet {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#anyMember()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#contains(TType)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#containsAll(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet#specialCasesIntersectedWith(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.TypeSet)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#enumerate()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#hasUniqueUpperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#isSingleton()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#isUniverse()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#iterator()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#makeClone()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#uniqueUpperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#upperBound()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.typesets.ArrayTypeSet#equals(java.lang.Object)
	 */
