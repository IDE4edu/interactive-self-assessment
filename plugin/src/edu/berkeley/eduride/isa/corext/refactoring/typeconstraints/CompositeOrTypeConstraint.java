...
public class CompositeOrTypeConstraint implements ITypeConstraint{
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.experiments.ITypeConstraint#toResolvedString()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.experiments.ITypeConstraint#isSimpleTypeConstraint()
	 */
