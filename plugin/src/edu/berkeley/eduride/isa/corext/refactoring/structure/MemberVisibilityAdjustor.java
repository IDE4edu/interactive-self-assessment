...
public final class MemberVisibilityAdjustor {
	 ...
	 * @since 3.2
	 */
	public static final GroupCategorySet SET_VISIBILITY_ADJUSTMENTS= new GroupCategorySet(new GroupCategory("edu.berkeley.eduride.isa.corext.visibilityAdjustments", //$NON-NLS-1$
	...
	public static class IncomingMemberVisibilityAdjustment implements IVisibilityAdjustment {
		...
		/*
		 * @see edu.berkeley.eduride.isa.corext.refactoring.structure.MemberVisibilityAdjustor.IVisibilityAdjustment#rewriteVisibility(edu.berkeley.eduride.isa.corext.refactoring.structure.MemberVisibilityAdjustor, org.eclipse.core.runtime.IProgressMonitor)
		 */
