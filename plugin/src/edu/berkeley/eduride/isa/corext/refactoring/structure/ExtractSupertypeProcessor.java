...
public final class ExtractSupertypeProcessor extends PullUpRefactoringProcessor {
	...
	private static final GroupCategorySet SET_EXTRACT_SUPERTYPE= new GroupCategorySet(new GroupCategory("edu.berkeley.eduride.isa.corext.extractSupertype", //$NON-NLS-1$
