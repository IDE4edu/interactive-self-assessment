 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.corext.refactoring.tagging;
...
public interface ISimilarDeclarationUpdating {
	 ...
	 *
	 * @param selectedStrategy one of the STRATEGY_* constants in {@link edu.berkeley.eduride.isa.corext.refactoring.rename.RenamingNameSuggestor}
	 */
	 ...
	 *
	 * @return one of the STRATEGY_* constants in {@link edu.berkeley.eduride.isa.corext.refactoring.rename.RenamingNameSuggestor}
	 */
