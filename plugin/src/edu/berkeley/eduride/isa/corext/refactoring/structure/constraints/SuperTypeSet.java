...
public abstract class SuperTypeSet implements ITypeSet {
	...
	private static class SuperTypeEmptySet extends SuperTypeSet {
		...
		/*
		 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ITypeSet#chooseSingleType()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ITypeSet#isEmpty()
		 */
		...
		/*
		 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ITypeSet#restrictedTo(edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ITypeSet)
		 */
