...
package edu.berkeley.eduride.isa.corext.refactoring.typeconstraints;
...
public class ConstraintVariableFactory implements IConstraintVariableFactory {
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeExpressionVariable(org.eclipse.jdt.core.dom.Expression, edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IContext)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeDeclaringTypeVariable(org.eclipse.jdt.core.dom.ITypeBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeDeclaringTypeVariable(org.eclipse.jdt.core.dom.IVariableBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeDeclaringTypeVariable(org.eclipse.jdt.core.dom.IMethodBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeParameterTypeVariable(org.eclipse.jdt.core.dom.IMethodBinding, int)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeRawBindingVariable(org.eclipse.jdt.core.dom.ITypeBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeReturnTypeVariable(org.eclipse.jdt.core.dom.ReturnStatement)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeReturnTypeVariable(org.eclipse.jdt.core.dom.IMethodBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeTypeVariable(org.eclipse.jdt.core.dom.Type)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.IConstraintVariableFactory#makeTypeVariable(org.eclipse.jdt.core.dom.ITypeBinding, java.lang.String, edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.CompilationUnitRange)
	 */
