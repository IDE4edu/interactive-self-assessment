...
import edu.berkeley.eduride.isa.corext.refactoring.structure.ReferenceFinderUtil;
...
public class MoveCuUpdateCreator {
	...
	private final static class Collector extends CollectingSearchRequestor {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.refactoring.CollectingSearchRequestor#acceptSearchMatch(SearchMatch)
		 */
