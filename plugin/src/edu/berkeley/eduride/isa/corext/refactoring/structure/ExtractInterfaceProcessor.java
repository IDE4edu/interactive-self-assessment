...
import edu.berkeley.eduride.isa.corext.refactoring.changes.CreateCompilationUnitChange;
import edu.berkeley.eduride.isa.corext.refactoring.changes.DynamicValidationRefactoringChange;
import edu.berkeley.eduride.isa.corext.refactoring.reorg.ASTNodeDeleteUtil;
...
import edu.berkeley.eduride.isa.corext.refactoring.structure.constraints.SuperTypeRefactoringProcessor;
...
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ISourceConstraintVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints2.ITypeConstraintVariable;
import edu.berkeley.eduride.isa.corext.refactoring.util.RefactoringASTParser;
import edu.berkeley.eduride.isa.corext.refactoring.util.RefactoringFileBuffers;
import edu.berkeley.eduride.isa.corext.refactoring.util.ResourceUtil;
import edu.berkeley.eduride.isa.corext.refactoring.util.TextEditBasedChangeManager;
...
public final class ExtractInterfaceProcessor extends SuperTypeRefactoringProcessor {
	...
	private static final GroupCategorySet SET_EXTRACT_INTERFACE= new GroupCategorySet(new GroupCategory("edu.berkeley.eduride.isa.corext.extractInterface", //$NON-NLS-1$
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.refactoring.structure.constraints.SuperTypeRefactoringProcessor#createContraintSolver(edu.berkeley.eduride.isa.corext.refactoring.structure.constraints.SuperTypeConstraintsModel)
	 */
