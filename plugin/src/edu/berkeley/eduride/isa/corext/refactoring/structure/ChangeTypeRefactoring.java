...
import edu.berkeley.eduride.isa.corext.refactoring.CollectingSearchRequestor;
...
import edu.berkeley.eduride.isa.corext.refactoring.rename.RippleMethodFinder2;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ASTCreator;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.CompositeOrTypeConstraint;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ConstraintCollector;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ConstraintOperator;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ConstraintVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ConstraintVariableFactory;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ExpressionVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.FullConstraintCreator;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ITypeConstraint;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ParameterTypeVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.ReturnTypeVariable;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.SimpleTypeConstraint;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.TypeConstraintFactory;
import edu.berkeley.eduride.isa.corext.refactoring.typeconstraints.TypeVariable;
...
public class ChangeTypeRefactoring extends Refactoring {
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.refactoring.base.Refactoring#checkActivation(org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.refactoring.base.Refactoring#checkInput(org.eclipse.core.runtime.IProgressMonitor)
	 */
...
// TODO: do sanity check somewhere if the refactoring changes any files.
	/*
	 * @see edu.berkeley.eduride.isa.corext.refactoring.base.IRefactoring#createChange(org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/*
	 * @see edu.berkeley.eduride.isa.corext.refactoring.base.IRefactoring#getName()
	 */
