 ...
 *******************************************************************************/
package edu.berkeley.eduride.isa.corext.dom.fragments;
...
public class ASTFragmentFactory {
	 ...
	 * the node to which the produced IASTFragment maps (see {@link  edu.berkeley.eduride.isa.corext.dom.fragments.IASTFragment  IASTFragment})
