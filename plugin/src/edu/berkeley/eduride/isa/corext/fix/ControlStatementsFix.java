...
public class ControlStatementsFix extends CompilationUnitRewriteOperationsFix {
	...
	private final static class ControlStatementFinder extends GenericVisitor {
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.dom.GenericVisitor#visit(org.eclipse.jdt.core.dom.DoStatement)
		 */
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.dom.GenericVisitor#visit(org.eclipse.jdt.core.dom.ForStatement)
		 */
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.dom.GenericVisitor#visit(org.eclipse.jdt.core.dom.IfStatement)
		 */
		...
		/* (non-Javadoc)
		 * @see edu.berkeley.eduride.isa.corext.dom.GenericVisitor#visit(org.eclipse.jdt.core.dom.WhileStatement)
		 */
